...
# TG CRASHER V2 — login-hardened. Cookie always sets. Loop has a fallback.
...
DB_PATH        = os.getenv("DB_PATH", "tg_crasher_v2.sqlite")
INDEX_FILE     = os.path.join(os.path.dirname(__file__), "index.html")

app = Flask(__name__)
app.secret_key = os.getenv("FLASK_SECRET", "tg-crasher-v2-fallback-secret-" + str(int(time.time())))
app.config.update(
